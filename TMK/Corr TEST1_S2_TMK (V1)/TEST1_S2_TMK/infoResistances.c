...
#include <math.h>		// fonctions Mathématique
...
e_validation ControleChoixSerie(enum e_valSerie)
{
	int valUser;
	scanf("%d", &valUser)
...
// Remarque					: -
//----------------------------------------------------------------------------------//
e_validation ControleValR(enum e_validation)
{
	float valUser;
	scanf("%d", &valUser);
...
e_validation ControlePoidPuissanceR(enum e_validation)
{
	int valUser;
	scanf("%d", &valUser);
...
// Remarque					: -
//----------------------------------------------------------------------------------//
e_validation CalculRUser(float)
{
	int valP
	float valR

	float Results = valR* pow(10, valP);
	return Results;
}
