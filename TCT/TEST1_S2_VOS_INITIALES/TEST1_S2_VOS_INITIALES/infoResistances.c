...
// Remarque					: -
//----------------------------------------------------------------------------------//
int ControleChoixSerie(enum e_validation)
{
	int valUser;

	scanf("%d", &valUser);

	if (valUser == CONST_K | valUser == CONST_M | valUser == CONST_G)
	{
		return OK;
	}
	else
...
// Remarque					: -
//----------------------------------------------------------------------------------//
float ControleValR(enum e_validation)
{
	float valUser;

	scanf("%d", &valUser);

	if (valUser >= 1 & valUser <= 10)
	{
		return OK;
	}
	else
...
// Remarque					: -
//----------------------------------------------------------------------------------//
int ControlePoidPuissanceR(enum e_validation)
{
	int valUser;
