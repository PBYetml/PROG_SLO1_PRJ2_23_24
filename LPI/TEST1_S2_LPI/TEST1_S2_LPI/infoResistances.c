...
void ControlChoixSerie(float valUser,int E_Validation)
{
	if (valUser == 4 || valUser == 6 || valUser == 24)
	{
		E_Validation = OK;
	}
	else
...
// Remarque					: -
//----------------------------------------------------------------------------------//
void ControleValR(float valUser, int E_Validation)
{
...
// Remarque					: -
//----------------------------------------------------------------------------------//
void ControlePoidPuissanceR(int valUser, int E_Validation)
{
	...
	{
		E_Validation = NOT_OK;
		printf("la serie n'est pas correcte");
	}
}
...
// Remarque					: -
//----------------------------------------------------------------------------------//
void CalculRNormalisee(s_SerieRX)
{
